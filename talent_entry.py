...
# Reality 69 заменяет все заранее заданные рекомендации персональным
# серверным перебором допустимых уровней по статистике конкретного игрока.
install_talent_optimizer_v69(core)
# Reality 70 оставляет точный перебор, но выполняет его только в фоне.
# Session и upgrade сразу получают быстрый персональный результат.
...
# возвращает весь расширенный интерфейс и API Reality 70.
