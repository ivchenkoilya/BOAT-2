...
from reality_event_games_v111 import install_reality_event_games_v111
...
# Reality 113 охватывает старый прямой путь начислений и ставит финансовые
# callback-кнопки выше общих игровых обработчиков.
install_finance_safety_v113(core)
