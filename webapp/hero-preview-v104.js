(()=>{
  ...
  const HEROES={
    1:{
      ...
      lore:'Когда-то Каблучий свободно странствовал по миру, но после заключения брачного союза оказался связан древними правилами семейного договора. Теперь для выхода из крепости ему требуется особое разрешение. Получив его, он ненадолго возвращается к друзьям и сражается так, будто следующего выхода может не быть.',
    ...
    2:{
      name:'Вайбус',title:'Призрак общей сходки',ability:'Я уже выхожу',cooldown:'8 минут',
    ...
    3:{
      name:'Солёний',title:'Владыка тухлых кроссовок',ability:'Переписать реальность',cooldown:'12 минут',
      lore:'Креативный и непредсказуемый работник завода, способный превратить любую глупую идею в легендарную историю. Его тухлые кроссовки создают настолько сильную ауру, что окружающие чувствуют приближение Солёния раньше, чем видят его. Сам он запаха не замечает и считает, что остальные просто не выдерживают его присутствия.',
      ...
      itemKey:'developer_sock',itemName:'Тухлые кроссовки Владыки',itemIcon:'👟',itemRarity:'ЛЕГЕНДАРНЫЙ',
    ...
    6:{
      name:'Сливариус',title:'Малый дипломат',ability:'Дипломатический манёвр',cooldown:'8 минут',
      lore:'Второй представитель «Плюс Вайба» и постоянный спутник Вайбуса. Редко появляется на встречах один, часто курит и не отличается крупными размерами. Маленький и щуплый, зато быстрый, прыгучий и невероятно скользкий. Умеет договариваться, находить компромиссы и дипломатично выбираться из сложных ситуаций.',
  ...
  function openModal(request){
    ...
    modal.dataset.heroId=String(heroId);
