(()=>{
  ...
  function marketScreen(){
    return `<section class="screen" data-screen="market132">
      ...
      <div class="v132-hero"><small>АДМИНИСТРАТИВНАЯ БИРЖА</small><b>Ручное управление рынком</b><span>Цена, движение курса, остановка торгов, новости и сброс к базовой стоимости.</span></div>
