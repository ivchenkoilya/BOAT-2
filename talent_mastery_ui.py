...
function renderSpecial(){
 ...
 let html='<div class="master-note">Особые узлы соединяют разные ветки, меняют правила игры и открываются за достижения. Финальные специализации каждой основной ветки взаимоисключающие.</div>';
 ...
 masterBody.innerHTML=html;masterBody.querySelectorAll('[data-upgrade]').forEach(b=>b.onclick=()=>upgradeSpecial(b.dataset.upgrade));
}
