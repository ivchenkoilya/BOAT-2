...
VERSION = "Reality 129 · Реформа власти и налогов"
...
def install_government_command_v129(core: Any) -> None:
    ...
    async def cmd_government_v129(message: Message) -> None:
        ...
        await message.answer(
            "🏛 <b>ГОСУДАРСТВО РЕАЛЬНОСТИ · REALITY 129</b>\n\n"
            "Выборные пороги снижены: депутат — <b>50 000</b>, председатель "
            "Госдумы — <b>100 000</b>, президент — <b>200 000</b> карьерного влияния.\n\n"
            "Президент напрямую назначает чиновников через личную панель полномочий. "
            "Госдума рассматривает законы, включая налог от <b>0% до 100%</b> "
            "с положительного игрового выигрыша.",
