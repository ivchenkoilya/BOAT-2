...
from bunker_route_fix_v145 import install_bunker_route_fix_v145
...
VERSION = "Reality 145 · Прямой маршрут Бункера"
...
def install_finance_entry_fix_v115(core: Any) -> None:
    ...
    async def cmd_finance_app_v115(message: Message) -> None:
        ...
        if not link:
            ...
            return
        await message.answer(
            "💸 <b>ФИНАНСОВЫЙ ЦЕНТР · REALITY 145</b>\n\n"
    ...
    install_bunker_route_fix_v145(core)
