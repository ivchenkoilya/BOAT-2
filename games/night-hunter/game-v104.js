(async()=>{
 ...
 try{
  ...
  const [parts,visual101,visual102,story104,fixes104]=await Promise.all([
   ...
   fetch('/games/night-hunter/game-v104-fixes.js?v=104',{cache:'no-store'}).then(r=>{if(!r.ok)throw new Error('исправления 104');return r.text()})
  ]);
